...
# Schölkopf
AUTHOR_ID_LIST = ['u7w1MYcAAAAJ', '0uEkSPQAAAAJ', 'NxrQ794AAAAJ', 'G4MBruQAAAAJ', 'DZ-fHPgAAAAJ']

# Order: Black, Kuchenbecker, Akata, Martius, Krone, Pfeifer, Bringmann, Maghsudi, Ochs, Kasneci, Berens, Eickhoff, Bethge
AUTHOR_ID_LIST_2 = ['b-JF-UIAAAAJ', 'srDA4dAAAAAJ', 'vXQwphYAAAAJ&hl', 'pk53ZkAAAAAJ', 'lgiJRgoAAAAJ', 'Llw9zY4AAAAJ', 'bZVkVvoAAAAJ', 'lPQLk3QAAAAJ', 'QQi1_rAAAAAJ', '0z0fNxUAAAAJ']
...
def saveAsCSV(cur_author, articles, location=None):
    ...
    if location == None:
        location = f'./articles_{name_cleaned}.csv'
    ...
    with open(location, mode='w', newline='', encoding='utf-8') as csv_file:
        ...
        for article in articles:
            if article["year"] != "" and int(article["year"]) >= threshold_year:
...
def main():
    ...
    for author_id in AUTHOR_ID_LIST:
        ...
        while 'next' in results.get("serpapi_pagination", {}) and articles[-1]["year"] != "" and int(articles[-1]["year"]) >= threshold_year:
